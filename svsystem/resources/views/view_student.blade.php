...
<body>
    ...
    @if($student)
        ...
        <h3 style="margin-left: auto; margin-right: auto; text-align: center;">Name: {{ $student->name }}</h3>
        <p style="text-align:center;">Student Number: {{ $student->student_no }}</p>   
        <p style="text-align:center;">Email: {{ $student->email }}</p>
